...
class _HomeState extends State<Home> {
  List<String> workers =['Driver','Maid','Electrician','Labourer','Plumber','Carpenter','Electrician'];
  int randomNumber;
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    SizedBox(height: 24,),
                    Text('The most searched worker is',style: kConstHeadingStyle.copyWith(color: Colors.white,fontSize: 20),),
                    SizedBox(height: 20,),
                    Text(workers[randomNumber],style: kConstHeadingStyle.copyWith(color: Colors.white,fontSize: 40),),
                  ],
                ),
              ),
              SizedBox(height: 8,),
